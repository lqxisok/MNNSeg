...
namespace UnityEngine.XR.ARFoundation
{
    ...
    public sealed class ARCameraBackgroundCustom : MonoBehaviour
    {
        ...
        ARFoundationBackgroundRendererCustom m_BackgroundRenderer { get; set; }
        ...
        void SetupBackgroundRenderer()
        {
            ...
            else
            {
                if (m_LegacyBackgroundRenderer == null)
                    m_LegacyBackgroundRenderer = new ARFoundationBackgroundRendererCustom();
        ...
        ARFoundationBackgroundRendererCustom m_LegacyBackgroundRenderer;

        ARFoundationBackgroundRendererCustom m_LwrpBackgroundRenderer;
